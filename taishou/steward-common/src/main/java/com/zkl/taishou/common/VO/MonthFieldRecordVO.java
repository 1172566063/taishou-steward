 ...
 */
@Data
@ApiModel("MonthFieldRecordVO")
@Accessors(chain = true)
public class MonthFieldRecordVO implements Serializable {
    /**
     * 串行版本ID
    */
